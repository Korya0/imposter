    ...
    return AnimatedSwitcher(
      ...
      child: Container(
        ...
        child: switch (state) {
          ...
          GameSessionScanning(currentPlayerIndex: final index) => ScanningPhaseWidget(
              playerNumber: index + 1,
              onScanTap: () => context.read<GameSessionCubit>().toggleReveal(reveal: true),
            ),
          GameSessionRevealing(
            ...
            RevealingPhaseWidget(
              isSpy: spy,
              secretWord: word,
              categoryName: context.read<GameSetupCubit>().state.selectedCategory?.name ?? '',
              onNext: () => context.read<GameSessionCubit>().toggleReveal(reveal: false),
            ),
          ...
          GameSessionSummary(
            ...
            SummaryPhaseWidget(
              ...
              spyCount: s,
              durationMinutes: d,
              onAnotherRound: context.read<GameSessionCubit>().prepareAnotherRound,
              onFinish: () {
